<template>
  <div>
    <div class="d-flex justify-content-evenly notFound">
      <div class="col-md-6 card my-40 " >
        <div class="d-flex bd-highlight mb-3 justify-content-evenly">
          <div class="p-1 bd-highlight justify-content-center" style="text-align: center;">
            <svg id="monkey_404" viewBox="0 0 800 480" class="row">
	...
	c-11.4,0-20.6-9.2-20.6-20.6c0-11.4,9.2-20.6,20.6-20.6h21.2c11.4,0,20.6,9.2,20.6,20.6C353.3,177.9,344.1,187.1,332.8,187.1z"/>
        ...
        <div class="d-flex bd-highlight mb-3 justify-content-center">
          <ul class="list-group p-2 list-group-flush">
            <li class="list-item p-1" style="text-align: center;"><h4 class="font-bold" >صفحه مورد نظر شما وجود ندارد </h4></li>
            <li class="list-item p-1"><a href="/" class="btn link-danger text-center form-control "> بازگشت به صحفه اصلی سایت</a></li>
          </ul>
        </div>
